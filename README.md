...
Data & Analytics: Pandas, NumPy, EDA, Feature Engineering, Statistical Analysis, Power BI, SQL

Backend & Deployment: FastAPI, Flask, REST APIs, Render, Chrome Extension (Manifest V3)
